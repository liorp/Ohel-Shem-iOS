...
class FirstTimeHereViewControllerManager: UIViewController, UIPageViewControllerDataSource {
    ...
    private let currentText = ["שלום", "כאן תוכל לבדוק את מערכת השינויים, מועדי המבחנים, מערכת השעות וחדשות בית-הספר", "וכל זאת- בלי שתצטרך לעזוב את האייפון!", "אנא היכנס עם שם-המשתמש והססמה שניתנו לך על-ידי המחנך בתחילת השנה, או הכנס נתונים אחר כך באופן ידני בלשונית ההגדרות באפליקציה"]
